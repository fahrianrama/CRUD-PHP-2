...
<footer id="footer">    
        ...
        <div class="container text-center">    
          <div class="row">
            ...
            <div class="col-sm-4 col-md-4">
              <div class="footer-content">
                <h4>Alamat</h4>
                <p>Jalan Niangas 67<br>
                Malang, Indonesia</p>
                <p>admin@Ilkomstudy.com</p>
              </div> <!-- end footer-content -->
            </div> <!-- end col-sm-4 -->
            <div class="col-sm-4 col-md-4">
              <div class="footer-content">
                <h4>SUPPORT</h4>
                <p>You need support? Contact Us here.</p>
                <p>+62 8155 55 82922 </p>
              </div>  <!-- end footer-content -->   
            </div> <!-- end col-sm-4 -->
          </div> <!-- end row -->
        </div> <!-- container -->
      ...
      <div class="footer-bottom text-center"> <!-- Footer-copyright -->
        <p>©2016 Design By <a href="http://templatestock.co">TEMPLATE STOCK</a></p>
      </div>
    </footer>
    <!-- End footer begings -->
